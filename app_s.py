...
st.write("Enter a long text below, and get a concise summary!\nThe LLM behind the scenes is 'sshleifer/distilbart-cnn-12-6'")
...
# Footer
st.markdown("---")
st.markdown("🔗 Built with [Hugging Face Transformers](https://huggingface.co/sshleifer/distilbart-cnn-12-6) & Streamlit 🚀")